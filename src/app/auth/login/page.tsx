        ...
        <div className="w-[500px] bg-white rounded-lg shadow-double px-[55px] py-[30px] flex flex-col items-center">
            ...
            <form className="w-full flex flex-col justify-between items-center grow" >
                <input
                    ...
                    name="email"
                    placeholder="Email"
                    className="peer w-full px-[15px] py-[9px] outline-none rounded-md border border-[#D1D1D1]"
                />
                <button
                    className="w-full h-[44px] rounded bg-blue-primary hover:bg-blue-secondary text-white transition-all"
                >
                    Continue
                </button>
