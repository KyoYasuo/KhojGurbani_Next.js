...
export default function SriGuruMedia(props: { shabadMedia: any }) {
    ...
    const user_role = session ? session.data.user.role_id : 1;
        ...
        <div className="">
            ...
            <div className="grid grid-cols-2">
                <div className="mb-[15px]">
                    ...
                    {
                        shabadMedia.Santhiya_data.map((media: { id: number; title: string; duration: string; attachment_name: string; author_name: string; media_approve: number; }) => {
                            return (
                ...
                <div className="mb-[15px]">
                    ...
                    {
                        shabadMedia.Kirtan_data.map((media: { id: number; title: string; duration: string; attachment_name: string; author_name: string; media_approve: number; }) => {
                            return (
                                <div key={media.id} className="flex gap-2 mb-[15px]">
                                    <div className="flex gap-2">
                                        <button
                ...
                <div className="mb-[15px]">
                    ...
                    {
                        shabadMedia.katha_data.map((media: { id: number; title: string; duration: string; attachment_name: string; author_name: string; media_approve: number; }) => {
                            return (
                                <div key={media.id} className="flex gap-2 mb-[15px]">
                                    <div className="flex gap-2">
                                        <button
                ...
                <div className="mb-[15px]">
                    ...
                    {
                        shabadMedia.podcast_media.map((media: { id: number; title: string; duration: string; attachment_name: string; author_name: string; media_approve: number; }) => {
                            return (
    ...
    if (user_role === 3 || user_role === 2) return (
        <div className="">
            <h3 className="text-[26px] text-[#252636] font-bold mb-[15px]">Audio</h3>
            <div className="grid grid-cols-2">
                <div className="mb-[15px]">
            ...
            <div className="flex mb-6">
                <button className="cursor-pointer flex bg-blue-primary items-center text-white px-[20px] py-[5px] text-[12px] gap-2 rounded group">
                    <svg
                        ...
                        className="w-3 h-3 group-hover:scale-110 transition-all fill-white"
                    >
                                    ...
                                    <SwiperSlide key={video.id}>
                                        <div className="flex flex-col gap-4">
                                            ...
                                            <button className="mr-auto cursor-pointer flex bg-[#DC3545] items-center justify-start text-white px-[20px] py-[5px] text-[12px] gap-2 rounded group">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-3 h-3 group-hover:scale-110 transition-all fill-white">
                                                    <path
                                        ...
                                        </div>
                                        {
                                            media.media_approve ?
                                                ...
                                                <div className="flex justify-start">
                                                    <button className="cursor-pointer flex items-center justify-start text-[#5CB85C] px-[10px] py-[5px] text-[12px] gap-2 rounded group">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                                                            <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                                                        </svg>
                                                        <span className="">Approve</span>
                                                    </button>
                                                    <button className="cursor-pointer flex items-center justify-start text-[#F0Ad4E] px-[10px] py-[5px] text-[12px] gap-2 rounded group">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
